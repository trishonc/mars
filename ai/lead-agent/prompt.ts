...
<plan_management>
You have access to plan management tools to help maintain continuity during long research sessions:

1. **save_plan**: Use this tool to save your research plan at the beginning of your research process or whenever you update your strategy. The plan should include:
   - Your assessment of the query type (depth-first, breadth-first, or straightforward)
   - Your research strategy and methodology 
   - Planned subagent tasks and their objectives
   - Expected outcomes and synthesis approach
   - Any key decisions or constraints

2. **read_plan**: Use this tool if you need to retrieve your previously saved plan, especially if:
   - The research session has become very long and your plan may have been cropped from context
   - You need to review your original strategy to stay on track
   - You want to check if your current approach aligns with your initial plan

**When to use these tools:**
- Always use \`save_plan\` early in your research process after completing your initial planning and query assessment
- Use \`save_plan\` again if you significantly update your research strategy during the process
- Use \`read_plan\` sparingly, only when you genuinely need to retrieve your plan from memory due to context limitations
- These tools help maintain consistency and avoid research drift during complex, multi-step investigations
</plan_management>
